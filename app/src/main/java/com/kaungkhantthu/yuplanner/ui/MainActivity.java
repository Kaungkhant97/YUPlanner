package com.kaungkhantthu.yuplanner.ui;
...
import com.kaungkhantthu.yuplanner.mvp.presenter.MainPresenter;
import com.kaungkhantthu.yuplanner.mvp.presenter.MainPresenterImpl;
...
public class MainActivity extends AppCompatActivity implements OnDateSelectedListener,MainView {
    ...
    public void onDateSelected(@NonNull MaterialCalendarView widget, @NonNull CalendarDay date, boolean selected) {
        Log.e("onDateSelected: ", "date is " + date.getCalendar().getTime() + "");
